...
var LinkDialog = {
	...
	checkPrefix : function(n) {
		if (n.value && Validator.isEmail(n) && !/^\s*mailto:/i.test(n.value) && confirm(tinyMCEPopup.getLang('morelinks_dlg.link_is_email')))
			n.value = 'mailto:' + n.value;

		if (/^\s*www\./i.test(n.value) && confirm(tinyMCEPopup.getLang('morelinks_dlg.link_is_external')))
	...
	fillRelList : function(id) {
		...
		lst.options[lst.options.length] = new Option(tinyMCEPopup.getLang('morelinks_dlg.image_rel_single'), 'lightbox');
		lst.options[lst.options.length] = new Option(tinyMCEPopup.getLang('morelinks_dlg.image_rel_multi'), 'lightbox[multi]');
	},
	...
	fillTargetList : function(id) {
		...
		lst.options[lst.options.length] = new Option(tinyMCEPopup.getLang('not_set'), '');
		//lst.options[lst.options.length] = new Option(tinyMCEPopup.getLang('morelinks_dlg.link_target_same'), '_self'); PATCH: hide
		lst.options[lst.options.length] = new Option(tinyMCEPopup.getLang('morelinks_dlg.link_target_blank'), '_blank');
